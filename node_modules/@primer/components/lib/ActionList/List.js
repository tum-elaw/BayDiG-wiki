...
function List(props) {
  ...
  const renderItem = (itemProps, item) => {
    ...
    const key = (_ref2 = (_itemProps$key = itemProps.key) !== null && _itemProps$key !== void 0 ? _itemProps$key : (_itemProps$id = itemProps.id) === null || _itemProps$id === void 0 ? void 0 : _itemProps$id.toString()) !== null && _ref2 !== void 0 ? _ref2 : (0, _uniqueId.uniqueId)();
  ...
  const singleGroupId = (0, _react.useMemo)(_uniqueId.uniqueId, []);
  ...
  return /*#__PURE__*/_react.default.createElement(StyledList, props, (_groups = groups) === null || _groups === void 0 ? void 0 : _groups.map(({
    header,
    ...groupProps
  }, index) => {
