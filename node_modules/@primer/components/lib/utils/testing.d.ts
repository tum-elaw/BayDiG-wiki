...
export declare function renderStyles(node: React.ReactElement): Record<string, string | Record<string, string>>;
export declare function getComputedStyles(className: string): Record<string, string | Record<string, string>>;
/**
