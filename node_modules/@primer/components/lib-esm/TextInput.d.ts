...
declare type StyledWrapperProps = {
    ...
    contrast?: boolean;
    variant?: 'small' | 'large';
} & SystemCommonProps & WidthProps & MinWidthProps & MaxWidthProps & SxProp;
declare const Wrapper: import("styled-components").StyledComponent<"span", any, StyledWrapperProps, never>;
