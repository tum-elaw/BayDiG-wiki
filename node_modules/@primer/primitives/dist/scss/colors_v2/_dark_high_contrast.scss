@mixin primer-colors_v2-dark_high_contrast {
  & {
    ...
    --color-diffstat-addition-bg: #09b43a;
    ...
    --color-diff-blob-num-text: #f0f3f6;
    ...
    --color-diff-blob-addition-num-bg: rgba(38,205,77,0.2);
    ...
    --color-diff-blob-deletion-num-bg: rgba(255,106,105,0.2);
    --color-diff-blob-hunk-text: #f0f3f6;
    --color-diff-blob-hunk-num-bg: #409eff;
